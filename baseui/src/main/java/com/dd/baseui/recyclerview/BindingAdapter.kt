...
package com.dd.baseui.recyclerview
...
import com.dd.baseui.recyclerview.animation.*
import com.dd.baseui.recyclerview.annotaion.AnimationType
...
import com.dd.baseui.recyclerview.listener.DefaultItemTouchCallback
import com.dd.baseui.recyclerview.listener.OnBindViewHolderListener
import com.dd.baseui.recyclerview.listener.OnHoverAttachListener
import com.dd.baseui.recyclerview.listener.throttleClick
 ...
 * 3. 通过接口实现来扩展功能 [com.dd.baseui.recyclerview.item]
 * 4. 快速添加触摸事件(防抖点击/快速点击/长按/选择/侧滑/拖拽)
 * 5. 强大的分组/展开/折叠/粘性头部/递归深度/动画/组position [expandOrCollapse]
 * 6. 自定义列表动画 [setAnimation] 默认动画 [com.dd.baseui.recyclerview.animation]
...
open class BindingAdapter : RecyclerView.Adapter<BindingAdapter.BindingViewHolder>() {
    ...
    companion object {
         ...
         */
        @Deprecated("函数优化", ReplaceWith("BRV.modelId", "com.dd.baseui.recyclerview.utils.BRV"))
