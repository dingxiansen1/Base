...
class StateLayout @JvmOverloads constructor(
    ...
    init {
        ...
        try {
            emptyLayout = attributes.getResourceId(R.styleable.StateLayout_empty_layouts, NO_ID)
            errorLayout = attributes.getResourceId(R.styleable.StateLayout_error_layouts, NO_ID)
            loadingLayout = attributes.getResourceId(R.styleable.StateLayout_loading_layouts, NO_ID)
        } finally {
            attributes.recycle()
        }
    }
