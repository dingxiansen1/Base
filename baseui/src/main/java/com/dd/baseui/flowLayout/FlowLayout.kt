...
open class FlowLayout @JvmOverloads constructor(
    ...
    private var mOnFoldChangedListener: OnFoldChangedListener? =
        null
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        var line = 0
        //左对齐
        if (mGravity == FlowLayout.Companion.DEFAULT_GRAVITY_LEFT) {
            //左侧需要先加上左边的padding
     ...
     * @param listener
     */
    fun setOnFoldChangedListener(listener: FlowLayout.OnFoldChangedListener?) {
    ...
    init {
        ...
        mFold = a.getBoolean(
            R.styleable.FlowLayout_flow_fold,
            DEFAULT_FOLD
        )
        mFoldLines = a.getInt(
            R.styleable.FlowLayout_flow_foldLines,
            DEFAULT_FOLD_LINES
        )
        mGravity = a.getInt(
            R.styleable.FlowLayout_flow_gravity,
            DEFAULT_GRAVITY_LEFT
        )
