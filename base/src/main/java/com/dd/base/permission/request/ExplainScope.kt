...
import com.dd.base.permission.request.ChainTask
import kotlin.jvm.JvmOverloads

/**
 * Provide specific scopes for [com.dd.base.permission.callback.ExplainReasonCallback]
 * and [com.dd.base.permission.callback.ExplainReasonCallbackWithBeforeParam] to give it specific functions to call.
 * @author guolin
 * @since 2020/3/18
 */
