...
import com.dd.base.toast.ToastX.ANIM_MODEL_SLIDE
import com.dd.base.toast.ToastX.DURATION_SHORT
import com.dd.base.toast.ToastX.POSITION_BOTTOM
import com.dd.base.toast.ToastX.POSITION_TOP
...
class SnackBarX {
    ...
    private var toastxbind : ViewDataBinding?=null
    /******参数部分********/
    ...
    fun customizeView(context: Context,layout: Int,block:(ViewDataBinding)->Unit): SnackBarX {
        toastxbind= DataBindingUtil.inflate(LayoutInflater.from(context),layout, null,false )
        toastxbind?.setVariable(ToastX.modelId,context)
        customizeView = toastxbind!!.root
        customizeView?.setOnClickListener {
            block.invoke(toastxbind!!)
        }
        return this
    }
